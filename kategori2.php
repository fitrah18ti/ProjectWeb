...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="home.php">Welcome to our Wedding Organizer</a>
        ...
        <div class="col-lg-9">
          ...
          <div class="card mt-4">
            ...
            <div class="card-body">
              ...
              <h4>Rp.50.000.000</h4>
              <p class="card-text">Pelaminan Lux dengan nuansa putih, memberi kesan suci di acara yang sakral, dihiasi dengan bunga yang sangat menyatu.</p>
